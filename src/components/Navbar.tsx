...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    setIsAdminEnabled(process.env.NEXT_PUBLIC_ADMIN_ENABLED === 'true');
  }, []);
          ...
          <form onSubmit={handleSearch} className="hidden md:flex items-center">
            <div className="relative">
              <input
                ...
                className="w-64 pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent placeholder-gray-400"
              />
